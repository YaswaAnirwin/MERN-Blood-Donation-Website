...
const getInventoryHospitalController = async (req, res) => {
  try {
    ...
    if (filters.donar) sanitizedFilters.donar = mongoose.Types.ObjectId(filters.donar);
    if (filters.hospital) sanitizedFilters.hospital = mongoose.Types.ObjectId(filters.hospital);
    if (filters.organisation) sanitizedFilters.organisation = mongoose.Types.ObjectId(filters.organisation);
