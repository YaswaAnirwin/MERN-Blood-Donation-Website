...
const getInventoryHospitalController = async (req, res) => {
  try {
    ...
    if (filters.hospital) {
      filters.hospital = mongoose.Types.ObjectId(filters.hospital); // SECURITY: Ensure hospital is a valid ObjectId
    }
    if (filters.organisation) {
      filters.organisation = mongoose.Types.ObjectId(filters.organisation); // SECURITY: Ensure organisation is a valid ObjectId
    }
    const inventory = await inventoryModel
      .find(filters)
      .populate("donar")
